        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <center>
                        <h1 class="card-title">แสดงรายการสินค้าทั้งหมด</h1>
              ...
              <label  class="input-group-prepend" style="padding:5px; float:right;"><span class="input-group-text">ค้นหา</span>
                  <input type="text" name="filter" placeholder="ค้นหาสินค้า....." id="filter"></label>
                                
                 
                        
                        <!--<h4 class="card-title">เพิ่มสินค้าเข้าสู่ระบบ</h4>-->
					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="ของใช้เด็ก"></td>
							...
							<tr>
								<td><label  class="col-form-label">แบรนด์:</label>
                                                        ...
                                                        <tr>
								<td><label  class="col-form-label">รายละเอียดสินค้า:</label>
                                                                    <input class="form-control" type="text" name="product_details" placeholder="ใส่รายละเอียดสินค้า" style="width:250px;" required></td>
							</tr>
							<tr>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID001"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="1"></td>
							</tr>
						</table>
					</center>
				</div>
			...
			if (isset($_POST['add']))
				...
				$q1 = mysqli_query($mysqli, "INSERT INTO product ( product_id,product_name, product_price, product_type, product_image, brand,  product_details ,category ,product_type_id )
				VALUES ('$product_code','$product_name','$product_price','$product_type','$name', '$brand','$product_details' , '$category','$product_type_id')");
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID001' ORDER BY product_id DESC") or die(mysqli_error());
