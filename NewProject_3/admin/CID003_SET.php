					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="สุขอนามัย"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID003"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="3"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID003' ORDER BY product_id DESC") or die(mysqli_error());
