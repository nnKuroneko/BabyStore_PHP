...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'การใช้ช่องทางการโอนของลูกค้าในปี <?php echo $date = date("Y"); ?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
				<?php 
				$result = mysqli_query($mysqil, "SELECT Banking FROM transaction Group by Banking");
				while($row = mysqli_fetch_array($result)){
				
				$brnd = $row['Banking'];
				
				$result1 = mysqli_query($mysqil, "SELECT * FROM transaction WHERE Banking = '$brnd'");
