					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="ยอดนิยม"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="Bookmark"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="0"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='Bookmark' ORDER BY product_id DESC") or die(mysqli_error());
