					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="ของเล่น"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID006"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="6"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID006' ORDER BY product_id DESC") or die(mysqli_error());
