				...
				$id = (int) $_SESSION['id'];
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">คำสั่งซื้อทั้งหมด</h3>
...
//. "ORDER BY tbitem.id DESC";
        ...
        echo 'จำนวน ' . $result->num_rows . ' รายการ';
        ...
        ?>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">จำนวนเงิน</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">
                                    ...
                                    $query = mysqli_query($mysqli, "SELECT * FROM transaction_detail LEFT JOIN product ON product.product_id=transaction_detail.product_id") or die(mysqli_error());
                                    
                                    $total = 0;
					while($fetch = mysqli_fetch_array($query))
						{
						 $subtotal = $fetch['product_price'] * $fetch['order_qty'];
                                                //$subtotal = $total + $srow['product_price'];
        ...
        ?>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">มีการรีวิวสินค้าทั้งหมด</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">
                                    <?php
        $mysqli = new mysqli("localhost", "root", "", "storebaby_db");
