					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="แพมเพิศและนมผง"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID007"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="7"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID007' ORDER BY product_id DESC") or die(mysqli_error());
