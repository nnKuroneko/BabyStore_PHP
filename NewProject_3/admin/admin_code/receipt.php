...
<table class="body-wrap">
    ...
    <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <td class="content-block">
                                        <table class="invoice">
                                            ...
                                            <?php
		$t_id = $_GET['tid'];
		$query = mysqli_query($mysqli, "SELECT * FROM transaction WHERE transaction_id = '$t_id'") or die (mysqli_error());
		$fetch = mysqli_fetch_array($query);
		
		$amnt = $fetch['amount'];
		echo "Date : ". $fetch['order_date']."";
		echo "<tbody><tr>";
                echo "<td>ชื่อ - นามสกุล<br>Invoice #12345<br>". $fetch['order_date']."</td></tr>";
                echo "<tr>";
                echo "<td>";
		...
		echo "<td class='alignright'>".$pprice." $</td> </tr>";
		}
                echo "<tr class='total'>";
