					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="คอลเลคชั่น"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="Collection"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="9"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='Collection' ORDER BY product_id DESC") or die(mysqli_error());
