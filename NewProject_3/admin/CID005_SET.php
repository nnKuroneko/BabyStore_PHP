					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="ชุดเครื่องนอน"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID005"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="5"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID005' ORDER BY product_id DESC") or die(mysqli_error());
