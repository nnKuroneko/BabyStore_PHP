...
<body>
    ...
    ***********************************-->
    ...
    <div class="container-fluid">
        ...
        $sql = "SELECT stock.stock_id,stock.product_id,stock.qty,product.product_id "
                . "FROM `stock` INNER JOIN product on stock.product_id = product.product_id ";
        //. "ORDER BY tbitem.id DESC"
//. "ORDER BY tbitem.id DESC";
        
        $result = $mysqli->query($sql);
        echo '<br><br>สต็อกสินค้าทั้งหมด ' . $result->num_rows . ' รายการ';
        ...
        ?>
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col">ไอดีสต็อกสินค้า</th>
                                ...
                                <tbody>
                                    ...
                                    while ($data = $result->fetch_object()) {
                                        ...
                                        echo '<td>' . $name . '</td>';
                                        echo '<td>' . $qty . '</td>';
                                        echo '<td>' . '<a href=editstock.php?id=' . $id . '>แก้ไข</a> &nbsp; <a href=admin_code/delstock.php?id=' . $id . '>ลบ</a></td>';
                                        echo '</tr>';
                                    }
                                    ?>             
                                </tbody>
            ...
            <div class="container">
                ...
                <!--    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="text">ไอดีสินค้า</label>
                        <input type="text" class="form-control" name="product_id" aria-describedby="รหัสสินค้า">
                    </div> 
           
                    <div class="mb-3">
                        <label for="text">เพิ่มจำนวนสินค้า</label>
                        <input type="text" class="form-control" name="qty" aria-describedby="เพิ่มจำนวนสินค้า">
                    </div>
