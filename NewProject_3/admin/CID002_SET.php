					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="ผลิตภัณฑ์"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID002"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="2"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID002' ORDER BY product_id DESC") or die(mysqli_error());
