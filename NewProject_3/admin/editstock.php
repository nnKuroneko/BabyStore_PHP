                ...
                <div class="content-body">
                    ...
                    <main class="container">
                        ...
                        <div class="starter-template">
                            ...
                            $mysqli = new mysqli("localhost", "root", "", "storebaby_db");
                            if (isset($_GET['id'])) {
                                $sql = "Select * from stock where stock_id=" . $_GET['id'];
                                $result = $mysqli->query($sql);
                                while ($data = $result->fetch_object()) {
                                    $qty = $data->qty;
                                    $id = $data->stock_id;
                                    ?>
                                    <form method="post" action="admin_code/EditDataStock.php">
                                        <input type="hidden" id="id" name="stock_id" value=<?php echo $id; ?>>
