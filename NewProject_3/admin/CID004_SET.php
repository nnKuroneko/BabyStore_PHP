					...
					<center>
						<table>
							...
							<tr>
								...
								<td><input type="hidden" name="product_type" value="โภชนาการ"></td>
							...
							<tr>
								<td><input type="hidden" name="category" value="CATEID004"></td>
							</tr>
                                                        <tr>
								<td><input type="hidden" name="product_type_id" value="4"></td>
							</tr>
						</table>
					</center>
				</div>
...
-->
					...
					$query = mysqli_query($mysqli, "SELECT * FROM `product` WHERE category='CATEID004' ORDER BY product_id DESC") or die(mysqli_error());
