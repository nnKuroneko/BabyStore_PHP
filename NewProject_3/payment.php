...
<body>
		...
		<label>alphaware</label>
			...
			<?php
				$id = (int) $_SESSION['id'];
					...
					$query = mysql_query ("SELECT * FROM useracc WHERE userid = '$id' ") or die (mysql_error());
	...
	<div id="profile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
							...
							<table>
								<tr>
									<td class="profile">Name:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
                                                                ...
                                                                <tr>
									<td class="profile">Username:</td><td class="profile"><?php echo $fetch['username'];?></td>
								</tr>
								<tr>
				...
				<div class="modal-footer">
					<a href="account.php?id=<?php echo $fetch['userid']; ?>"><input type="button" class="btn btn-success" name="edit" value="Edit Account"></a>
...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="category001_1.php"> 			 <i class="icon-th-list"></i>Product</a></li>
                            <!--
