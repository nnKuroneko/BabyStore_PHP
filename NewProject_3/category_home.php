                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="hero-cap text-center">
                                    <h2>รายการสินค้าสำหรับลูกน้อย</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                                                                                
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link active" id="cid001-tab" data-toggle="tab" href="#cid001" role="tab" aria-controls="cid001" aria-selected="true">ของใช้</a>
